...
export function Sidebar() {
    ...
    return (_jsxs("aside", { className: "fixed left-0 top-0 z-40 flex h-screen w-64 flex-col border-r border-sidebar-border bg-sidebar", children: [_jsxs("div", { className: "flex h-16 items-center gap-3 border-b border-sidebar-border px-6", children: [_jsx("div", { className: "flex h-9 w-9 items-center justify-center rounded-lg bg-primary", children: _jsx("span", { className: "text-lg font-bold text-primary-foreground", children: "N" }) }), _jsxs("div", { className: "flex flex-col", children: [_jsx("span", { className: "text-sm font-bold text-sidebar-foreground", children: "NetrunCMS" }), _jsx("span", { className: "text-xs text-sidebar-foreground/60", children: "Admin Panel" })] })] }), _jsxs("nav", { className: "flex-1 overflow-y-auto px-3 py-4", children: [_jsx("div", { className: "space-y-1", children: mainNavItems.map((item) => (_jsx(NavItemComponent, { item: item }, item.href))) }), siteId && (_jsxs("div", { className: "mt-6", children: [_jsx("div", { className: "mb-2 px-3 text-xs font-semibold uppercase tracking-wider text-sidebar-foreground/50", children: "Current Site" }), _jsxs("div", { className: "space-y-1", children: [_jsxs(NavLink, { to: `/sites/${siteId}/pages`, className: ({ isActive }) => cn('flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors', isActive
                                            ...
                                            ? 'bg-sidebar-accent text-sidebar-accent-foreground'
                                            : 'text-sidebar-foreground/80 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground'), children: [_jsx(Palette, { className: "h-5 w-5" }), _jsx("span", { children: "Theme" })] })] }), _jsx("div", { className: "mb-2 mt-4 px-3 text-xs font-semibold uppercase tracking-wider text-sidebar-foreground/50", children: "Artist Content" }), _jsxs("div", { className: "space-y-1", children: [_jsxs(NavLink, { to: `/sites/${siteId}/releases`, className: ({ isActive }) => cn('flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors', isActive
                                            ? 'bg-sidebar-accent text-sidebar-accent-foreground'
                                            : 'text-sidebar-foreground/80 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground'), children: [_jsx(Disc3, { className: "h-5 w-5" }), _jsx("span", { children: "Releases" })] }), _jsxs(NavLink, { to: `/sites/${siteId}/events`, className: ({ isActive }) => cn('flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors', isActive
                                            ? 'bg-sidebar-accent text-sidebar-accent-foreground'
