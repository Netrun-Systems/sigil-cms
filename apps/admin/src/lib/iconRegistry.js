 ...
 */
import { Disc3, CalendarDays, User, Camera, Mail, Inbox, MessageSquare, FileText, Image, Globe, Palette, Settings, LayoutDashboard, Music, Rss, Search, Plus, Puzzle, ShoppingBag, Receipt, CreditCard, Shirt, CalendarCheck, Clock, FolderTree, MessageCircle, Activity, FlaskConical, Upload, } from 'lucide-react';
const icons = {
    Disc3,
    CalendarDays,
    User,
