...
export function SiteEditor() {
    ...
    const existingSite = isEditing
        ? {
            ...
            metaDescription: 'Netrun Systems provides enterprise cloud infrastructure, DevSecOps, and multi-tenant management platforms.',
        }
        : null;
    const [formData, setFormData] = useState(existingSite || defaultFormData);
