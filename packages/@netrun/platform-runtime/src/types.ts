/**
 * Platform plugin contract interfaces
 *
 * Defines the API surface that plugins use to register routes,
 * block types, admin navigation, and migrations.
 *
 * This is the canonical source — @netrun-cms/plugin-runtime re-exports from here.
 */
...
export interface PluginContext {
  ...
  /** Register block types that this plugin provides (optional — CRM plugins skip this) */
  ...
  /** Emit a platform event through the event bus */
  emitEvent(event: {
    type: string;
    siteId: string;
    resourceType: string;
...
/**
 * The main plugin interface. Each plugin exports a default PlatformPlugin object.
 */
export interface PlatformPlugin {
  /** Unique plugin identifier (e.g., 'artist', 'mailing-list', 'crm-contacts') */
  id: string;
  /** Human-readable name */
  name: string;
  /** Semver version */
...
/**
 * Backward-compatible alias — existing CMS plugins use this name.
 */
export type CmsPlugin = PlatformPlugin;
